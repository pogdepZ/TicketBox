...
1. Admin upload PDF.
2. File lưu vào MinIO/S3.
3. Backend tạo job `generate_artist_bio`.
4. Worker tải file.
5. Worker extract text từ PDF.
6. Làm sạch text.
7. Gửi prompt sang AI model.
8. Lưu kết quả vào `concerts.artist_bio`.
9. Update `artist_bio_status = done`.
