...
const DatePickerCore = ({
    ...
    const [headers] = useState([
        t("weekdayShort.monday"),
        t("weekdayShort.tuesday"),
        t("weekdayShort.wednesday"),
        t("weekdayShort.thursday"),
        t("weekdayShort.friday"),
        t("weekdayShort.saturday"),
        t("weekdayShort.sunday"),
    ]);
